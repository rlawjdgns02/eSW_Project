...
import math
import numpy as np
from Utils import map_to_color, choice_color

class Bubble:
    """버블 클래스"""
    def __init__(self, color, position=(0, 0), radius=10, angle=-90, screen_size=(240, 240), speed=5):
        ...
        if self.color == 'red':
            ...
            self.image_path = "/home/KimiHun/TA-ESW/project/drawable/bomb.png"
            self.image = Image.open(self.image_path).resize((20, 20))
...
def create_bomb(cannon, screen_width, screen_height):
    color = "black"
    angle = cannon.angle
