...
#     """맵 데이터를 생성합니다."""
#     return [
#         ["R", "R", "Y", "Y", "B", "B", "G", "G", "R", "R", "B", "B"],
#         ["R", "R", "Y", "Y", "B", "B", "G", "R", "Y", "Y", "B", "/"],
#         ["B", "B", "G", "G", "R", "R", "Y", "Y", "R", "Y", "Y", "B"],
#         ["B", "G", "G", "R", "R", "Y", "Y", "R", "Y", "Y", "B", "/"],
#         [".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "."],
#         [".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "/"],
#         [".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "."],
#         [".", ".", ".", ".", ".", ".", ".", ".", ".", ".", ".", "/"],
...
def create_bubbles(map_data, screen_width, screen_height):
    bubbles = []
    color_map = {"R": "red", "Y": "yellow", "B": "blue", "G": "green", "P" : "purple"}
